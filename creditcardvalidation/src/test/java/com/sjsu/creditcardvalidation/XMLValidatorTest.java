...
public class XMLValidatorTest {
	...
	public void testNumeric() {
		...
		assertTrue(xmlValidator.isNumeric(validNumStr));

		// Test with null input
		String nullStr = null;
		assertFalse(xmlValidator.isNumeric(nullStr));

		// Test with a non-numeric string
		String nonNumericStr = "abc";
		assertFalse(xmlValidator.isNumeric(nonNumericStr));

		// Test with a string containing a mix of numeric and non-numeric characters
		String mixStr = "123abc";
		assertFalse(xmlValidator.isNumeric(mixStr));
	...
	public void testValidatewithValidInput() throws IOException {
		ArrayList<CreditCard> result = xmlValidator.validate("Sample_Test_Files/input_file.xml");
