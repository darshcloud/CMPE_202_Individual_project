...
public class CSVValidatorTest {
	...
	public void testNumeric() {
		...
		assertTrue(csvValidator.isNumeric(validNumStr));

		// Test with null input
		String nullStr = null;
		assertFalse(csvValidator.isNumeric(nullStr));

		// Test with a non-numeric string
		String nonNumericStr = "abc";
		assertFalse(csvValidator.isNumeric(nonNumericStr));

		// Test with a string containing a mix of numeric and non-numeric characters
		String mixStr = "123abc";
		assertFalse(csvValidator.isNumeric(mixStr));
	}
	...
	public void testValidatewithValidInput() throws IOException {
		ArrayList<CreditCard> result = csvValidator.validate("Sample_Test_Files/input_file-1.csv");
